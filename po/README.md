# How to Translate jots

## First Things First

* Clone this repository by opening the terminal in a folder of your choice and typing ```git clone https://github.com/comicdeed/jots```
...
And that's it! You've successfully translated jots for your language!
